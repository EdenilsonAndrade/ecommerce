  		...
  		<div class="box box-primary">
            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                  <!-- a função loop irá bucar o array que foi informado na rota da pagina no setTpl. Os valores são informados em cada campo da tag td -->
                  ...
                  <tr>
                    ...
                    <td>
                      <!-- rotas para editar e excluir usuários -->
